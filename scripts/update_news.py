...
try:
    from scripts.tech_relevance import AI_BROAD_RELEVANCE_FLOOR, add_ai_relevance_fields, is_broadly_ai_related, score_ai_relevance
except ModuleNotFoundError:  # pragma: no cover - direct `python scripts/update_news.py`
    from tech_relevance import AI_BROAD_RELEVANCE_FLOOR, add_ai_relevance_fields, is_broadly_ai_related, score_ai_relevance
...
CURATED_AI_MEDIA_FEEDS: tuple[dict[str, Any], ...] = (
    ...
    # ---- broad tech: chips / semis / hardware / dev / security ----
    {
        "title": "The Verge (all)",
        "xml_url": "https://www.theverge.com/rss/index.xml",
    ...
    {
        "title": "Ars Technica",
        "xml_url": "https://feeds.arstechnica.com/arstechnica/index",
        "html_url": "https://arstechnica.com/",
        "max_entries": 10,
    },
    {
        "title": "The Register",
        "xml_url": "https://www.theregister.com/feed",
        "html_url": "https://www.theregister.com/",
        "max_entries": 10,
    },
    {
        "title": "Tom's Hardware",
        "xml_url": "https://www.tomshardware.com/feeds/all",
        "html_url": "https://www.tomshardware.com/",
        "max_entries": 10,
    },
    {
        "title": "Tom's Guide",
        "xml_url": "https://www.tomsguide.com/feeds/xml/rss",
        "html_url": "https://www.tomsguide.com/",
        "max_entries": 8,
    },
    {
        "title": "Engadget",
        "xml_url": "https://www.engadget.com/rss.xml",
        "html_url": "https://www.engadget.com/",
        "max_entries": 10,
    },
    {
        "title": "Wired",
        "xml_url": "https://www.wired.com/feed/rss",
        "html_url": "https://www.wired.com/",
        "max_entries": 8,
    },
    {
        "title": "Techmeme",
        "xml_url": "https://www.techmeme.com/rss.xml",
        "html_url": "https://www.techmeme.com/",
        "max_entries": 15,
    },
    {
        "title": "BleepingComputer (security)",
        "xml_url": "https://www.bleepingcomputer.com/feed/",
        "html_url": "https://www.bleepingcomputer.com/",
        "max_entries": 8,
    },
    {
    ...
    },
    {
        ...
        "xml_url": "https://feeds.bloomberg.com/technology/news.rss",
        "html_url": "https://www.bloomberg.com/technology",
        "max_entries": 8,
    },
)
...
HN_ALGOLIA_QUERIES: tuple[str, ...] = (
    ...
    "Copilot",
    "Nvidia AI",
    # broad tech: chips / semis / hardware / robotics / dev
    "Nvidia GPU",
    "TSMC",
    "Intel chip",
    "AMD",
...
def main() -> int:
    ...
    latest_payload = {
        ...
        "topic_filter": "tech_broad_scoring_v1_0",
        "ai_relevance_threshold": 0.65,
        "tech_relevance_mode": "broad",
